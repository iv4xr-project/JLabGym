...
public class Platform {
    ...
    private static String NOT_INSTALLED_MESSAGE = PrintColor.FAILURE()
            + ": It seems that you do not have the game installed on your pc, please visit our website/git on how to install the game!\n"
    ...
    public static String PathToLabRecruitsExecutable(String LabRecruitsRootDir) {
        // String path = Paths.get(System.getProperty("user.dir"), "gym",
        // current.toString(), "bin").toAbsolutePath().toString();
